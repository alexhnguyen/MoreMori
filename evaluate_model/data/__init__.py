...
from evaluate_model.data.base_data_loader import BaseDataLoader
from evaluate_model.data.base_dataset import BaseDataset
...
def find_dataset_using_name(dataset_name):
    ...
    # will be imported.
    dataset_filename = "evaluate_model.data." + dataset_name + "_dataset"
